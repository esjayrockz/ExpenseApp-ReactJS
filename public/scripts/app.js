...
var BucketListApp = function (_React$Component) {
  _inherits(BucketListApp, _React$Component);

  function BucketListApp(props) {
    _classCallCheck(this, BucketListApp);

    var _this = _possibleConstructorReturn(this, (BucketListApp.__proto__ || Object.getPrototypeOf(BucketListApp)).call(this, props));
  ...
  _createClass(BucketListApp, [{
    ...
    value: function render() {
      ...
      var title = 'BucketListApp';
      var subtitle = 'Create your bucket list.';
