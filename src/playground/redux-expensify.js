...
const expenseOne = store.dispatch(addExpense({description:'Rent', amount: 25000, createdAt: -11000}));
const expenseTwo = store.dispatch(addExpense({description:'coffee', amount: 24000, createdAt: -1000}));
